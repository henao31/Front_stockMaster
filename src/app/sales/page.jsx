                ...
                <div className="w-full flex flex-col gap-2 items-center">
                    ...
                    <div className="w-full flex flex-col gap-2 border-[3px] border-slate-300 py-5  bg-slate-100 rounded-lg">
                        <div className="w-full flex flex-row justify-between gap-2 px-10 text-xl font-medium">
                            ...
                            <div className="">$ {productSale.precio*productSale.cantidad || 0}</div>
                        </div>
                    </div>
                    <div className="w-full flex justify-end mt-3">
                        <div className="bg-[#7F88D5] text-white px-5 text-2xl py-4 font-semibold rounded-lg hover:bg-[#939efa] hover:text-black cursor-pointer">
                            Comprar
                        </div>
                    </div>
                </div>
